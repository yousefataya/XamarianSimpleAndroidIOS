...
namespace Restaurant.Core
{
    ...
    public abstract class CorePlatformInitializer : IPlatformInitializer
    {
        ...
        public IContainer Build()
        {
            ...
            /*builder.RegisterType<SelectRolePageViewModel>().As<ISelectRolePage>();*/
            builder.RegisterType<SelectRoleBaseViewModel>().As<ISelectRoleDetails>();
            builder.RegisterType<SelectResturantInfoViewModel>().As<IRestaruantInfoViewModel>();
            builder.RegisterType<SelectResturantFoodsViewModel>().As<IResturantFoodsViewModel>();
            ...
            builder.RegisterType<Windows10ThemeViewModel>().As<IWindows10ThemeViewModel>();
