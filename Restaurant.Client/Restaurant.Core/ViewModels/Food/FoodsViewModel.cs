    ...
    public class FoodsViewModel : BaseViewModel
    {
        ...
        public async Task LoadFoods()
        {
            ...
            try
            {
                ...
                var list = new ObservableCollection<FoodViewModel>();
                foreach (var food in foodsViewModel)
                {
                    if (food.Name.Equals("Hamburger")) {
                        food.Picture = "recipepizzaicon_109877.png";
                        food.Name = "بيتزا";
                        food.Description = "FastFood";
                    }
                    else if (food.Name.Equals("Steak"))
                    {
                        food.Picture = "recipechickenicon_109884.png";
                        food.Name = "ستيك دجاج";
                        food.Description = "FastFood";
                    }

                    else if (food.Name.Equals("Sushi"))
                    {
                        food.Picture = "recipechickenicon_109884.png";
                        food.Name = "سوشي/sushi";
                        food.Description = "FastFood";
                    }
                    list.Add(food);
                }
