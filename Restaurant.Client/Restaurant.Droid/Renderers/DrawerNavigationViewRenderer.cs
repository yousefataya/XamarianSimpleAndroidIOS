            ...
            Android.Support.Design.Widget.NavigationView.NavigationItemSelectedEventArgs e)
        {
            ...
            switch (e.MenuItem.ItemId)
            {
                ...
                case Resource.Id.nav_orders:
                    Element.OnNavigationItemSelected(
                        new NavigationItemSelectedEventArgs { SelectedViewModel = NavigationItem.Info });
                    break;
                ...
                case Resource.Id.nav_about:
                    ...
                    break;
                case Resource.Id.nav_role:
                    Element.OnNavigationItemSelected(
                        new NavigationItemSelectedEventArgs { SelectedViewModel = NavigationItem.SelectRoleWorker });
                    break;
            }
        }
