...
using Restaurant.Mobile.UI.Views;
using Xamarin.Forms;
...
namespace Restaurant.Mobile.UI
{
    public abstract class MobilePlatformInitializer : CorePlatformInitializer
    {
        protected override void RegisterTypes(ContainerBuilder builder)
        {
            ...
            builder.RegisterType<SelectRoleDetail>().As<IViewFor<SelectRoleBaseViewModel>>();
            builder.RegisterType<ResturantFoodInfo>().As<IViewFor<SelectResturantFoodsViewModel>>();
            builder.RegisterType<Windows10Theme>().As<IViewFor<Windows10ThemeViewModel>>();
            builder.RegisterType<ResturantInfo>().As<IViewFor<SelectResturantInfoViewModel>>();
